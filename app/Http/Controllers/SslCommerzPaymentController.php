...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // public $customer_name = $request->customer_name;
        // public $customer_email = $request->customer_email;
        // public $customer_phone_number = $request->customer_phone_number;
        // public $customer_country_id = $request->customer_country_id;
        // public $customer_city_id = $request->customer_city_id;
        // public $customer_address = $request->customer_address;
        // public $customer_postcode = $request->customer_postcode;
        // public $customer_message = $request->customer_message;
        # Here you have to receive all the order data to initate the payment.
        # Let's say, your oder transaction informations are saving in a table called "orders"
        # In "orders" table, order unique identity is "transaction_id". "status" field contain status of the transaction, "amount" is the order amount to be paid and "currency" is for storing Site Currency which will be checked with paid currency.

        $post_data = array();
        $post_data['total_amount'] = session('session_total'); # You cant not pay less than 10
        ...
        $post_data['cus_country'] = $request->customer_country_id;
        $post_data['cus_phone'] = $request->customer_phone_number;
        $post_data['cus_fax'] = "";
